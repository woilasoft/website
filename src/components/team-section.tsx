...
//     description: "Full-stack developer with 8+ years of experience building scalable financial applications.",
...
//     description: "Strategic product leader focused on creating user-centric financial solutions.",
//     image: "/placeholder.svg?height=200&width=200",
//     social: {
//       twitter: "#",
//       instagram: "#",
...
//     description: "Expert in financial modeling and risk assessment with deep market insights.",
//     image: "/placeholder.svg?height=200&width=200",
//     social: {
//       twitter: "#",
//       instagram: "#",
...
//     name: "Emma Rodriguez",
//     title: "UX Designer",
//     description: "Passionate about creating intuitive interfaces that simplify complex financial processes.",
//     image: "/placeholder.svg?height=200&width=200",
//     social: {
//       twitter: "#",
//       instagram: "#",
...
const createSlides = (members: typeof teamMembers) => {
  const slides = []
...
export default function TeamSection() {
  const originalSlides = createSlides(teamMembers)
    ...
    >
      <div className="screen-wrapper max-w-5xl">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">Meet our soldier of finance</h2>
            ...
            {clonedSlides.map((slide, slideIndex) => (
              <div key={`slide-${slideIndex}`} className="w-full flex-shrink-0">
                <div className="grid md:grid-cols-2 gap-12">
                  {slide.map((member) => (
                    <div key={`${slideIndex}-${member.id}`} className="flex gap-6">
                      {/* Profile Image */}
            ...
            {originalSlides.map((_, index) => (
              <div
                ...
                className={`h-1 rounded-full transition-all duration-300 ${
                  index === getRealIndex() ? "w-16 bg-secondary" : "w-8 bg-white"
                }`}
              ></div>
            ))}
          </div>
